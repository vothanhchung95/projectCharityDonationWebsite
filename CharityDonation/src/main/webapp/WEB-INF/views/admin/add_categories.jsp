...
<body>
	...
	<div class="mx-5">
		<h2 class="text-center my-5">Thêm Danh mục</h2>

		<div id="content">

			<c:url value="/admin/insert_categories" var="insertCategories"></c:url>
			<form:form action="${insertCategories}" class="create-form" method="POST"
