...
<title>${foundation.name}</title>
</head>
<body>
	<div class="container">

		<h3 class="my-4">${foundation.name}</h3>
		<h5 class="text-muted mb-4">${foundation.description}</h5>
		<h5 class="text-muted font-italic mb-4">Email: ${foundation.email}</h5>
